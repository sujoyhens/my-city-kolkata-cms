...
export interface ApiCoverContentCoverContent extends Schema.CollectionType {
  collectionName: 'cover_contents';
  info: {
    singularName: 'cover-content';
    pluralName: 'cover-contents';
    displayName: 'cover-content';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::cover-content.cover-content',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHealthcareHealthcare extends Schema.CollectionType {
  ...
  attributes: {
    borough: Attribute.String;
    establishmentname: Attribute.String;
    address: Attribute.Text;
    latitude: Attribute.Decimal;
    longitude: Attribute.Decimal;
    uphcno: Attribute.Integer;
    wardno: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMycitykolkataMycitykolkata extends Schema.CollectionType {
  collectionName: 'mycitykolkatas';
  info: {
    singularName: 'mycitykolkata';
    pluralName: 'mycitykolkatas';
    displayName: 'mycitykolkata';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    gmaplink: Attribute.String;
    zomatourl: Attribute.String;
    swiggyurl: Attribute.String;
    weburl: Attribute.String;
    wikipediaurl: Attribute.String;
    otherurl: Attribute.String;
    popularity: Attribute.Decimal;
    ratings: Attribute.Decimal;
    suggested: Attribute.Boolean & Attribute.DefaultTo<false>;
    contactdetails: Attribute.Text;
    cuisine: Attribute.String;
    nextsuggestion: Attribute.JSON;
    point_to_note: Attribute.Text;
    trivia: Attribute.Text;
    visiting_hours: Attribute.Text;
    ...
    descriptionnew: Attribute.RichText;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::mycitykolkata.mycitykolkata',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::cover-content.cover-content': ApiCoverContentCoverContent;
      'api::healthcare.healthcare': ApiHealthcareHealthcare;
      'api::mycitykolkata.mycitykolkata': ApiMycitykolkataMycitykolkata;
